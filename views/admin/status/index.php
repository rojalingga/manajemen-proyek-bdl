        ...
        <div class="card">
            <div class="card-header">
                <div class="d-flex align-content-center justify-content-between">
                    <h3 class="font-weight-bold text-xl">Status</h3>
    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-md" role="document">
        <div class="modal-content">
            <div class="modal-header bg-primary">
                <h5 class="modal-title white" id="myModalLabel160">Form Status
                </h5>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '.edit-button', function() {
            ...
            $.get(url, function(response) {
                if (response.status === 'success') {
                    $('#primary_id').val(response.data.id_status);
                    $('#nama_status').val(response.data.nama_status);
        ...
        $('#formData').on('submit', function(e) {
            ...
            let url = id ? '/admin/status/update/' + id : '/admin/status/store';
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    audio.play();
                    let msg = id ? "Status berhasil diupdate!" : "Status berhasil ditambahkan!";
        ...
        $(document).on('click', '.delete-button', function(e) {
            ...
            Swal.fire({
                ...
                text: 'Status ini akan dihapus secara permanen!',
                icon: 'warning',
                ...
                preConfirm: () => {
                    return new Promise((resolve) => {
                        ...
                        $.ajax({
                            ...
                            success: function() {
                                audio.play();
                                toastr.success("Status telah dihapus!", "BERHASIL", {
                                    progressBar: true,
                                    timeOut: 3500,
                                    positionClass: "toast-bottom-right"
                                });
