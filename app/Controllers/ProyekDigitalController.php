...
require_once __DIR__ . '/../models/ProyekDigital.php';

class ProyekDigitalController extends Controller
{
    private $proyekModel;

    public function __construct()
    {
        $this->proyekModel = new ProyekDigital();
    }
        ...
        if (isset($_GET['ajax'])) {
            ...
            try {
                ...
                foreach ($datatables as $row) {
                    $editUrl   = '/admin/proyek/' . $row['id'];
                    $deleteUrl = '/admin/proyek/delete/' . $row['id'];
    ...
    public function store()
    {
        ...
        try {
            $this->proyekModel->insert($insertData);
    ...
    public function update($id)
    {
        ...
        $data     = $_POST;
        $existing = $this->proyekModel->findById($id);
